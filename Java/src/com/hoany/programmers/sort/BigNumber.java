...
public class BigNumber {
    public static void main(String[] args) {
        ...
        // 그렇기 때문에 정수형 배열을 문자열 배열로 변환해야 한다.

        // 그다음 그냥 정렬하면 될것 같지만 30과 같은 뒤에 0이 붙어있는 숫자들이 있기 때문에 가장 큰수가 만들어질 수 없다.
        // 가장 큰 숫자를 만들기 위해서는 0을 맨 뒤로 보내야 한다는 것을 유념해야 한다.

        // 따라서 30과 같은 수를 아스키 코드로 분리해 보면 3과 0으로 분리되어 표기된다.
